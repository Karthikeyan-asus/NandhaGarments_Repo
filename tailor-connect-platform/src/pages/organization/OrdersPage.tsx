...
export default function OrganizationOrdersPage() {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      ...
      setIsLoading(true);
      try {
        // For org_admin, fetch orders by organization
        const response = await ordersService.getOrdersByOrg(user.orgId);
  ...
  return (
    <MainLayout>
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-display font-bold text-gray-900 mb-2">Organization Orders</h1>
          <p className="text-gray-600">View and track all orders for your employees</p>
        </div>
        ...
        {orders.length === 0 ? (
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-gray-600 mb-6">No orders have been placed for your employees yet.</p>
              <Button asChild>
                <a href="/organization/org-users">Order for Employees</a>
              </Button>
            </CardContent>
          </Card>
        ) : (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                View the status and details of orders placed for your employees
              </CardDescription>
            </CardHeader>
